...
student1 = Student("kalyan",22,"CNU112","mca",2026,"Intermediate","Male","IT")

student2 = Student("bhuvan",22,"CNU111","biotechnolgy",2026,"Intermediate","Female","IT")

faculty1 = Faculty("mohan",45,"F001","AI & ML","PhD","Male")

faculty2 = Faculty("harika",50,"F002","python","PhD","Female")
